...
def Record_Option(option):
    ...
    VideoFile_name = f'D:\\project\Investigation and Development of the Artificial Intelligent Voice Assistant Using Machine Learning\\JARVIS\\JARVIS\\Recorded\\Screen\\VideoFile-{time_stamp}.mp4'
    AudioFile_name = f'D:\\project\Investigation and Development of the Artificial Intelligent Voice Assistant Using Machine Learning\\JARVIS\\JARVIS\\Recorded\\Audio\\AudioFile-{time_stamp}.wav'
    OutputFileName = f'D:\\project\Investigation and Development of the Artificial Intelligent Voice Assistant Using Machine Learning\\JARVIS\\JARVIS\\SCREENRECORDED\\VideoFile-{time_stamp}.mp4'
    frames=[]
