...
#function that will take the commands  to convert voice into text
    ...
    def run_jarvis(self):
        ...
        while True:
            ...
            #Eg: Jarvis play music
                ...
                music_dir = 'C:\\Users\\white devil\\music' #change the song path directory if you have songs in other directory
    ...
    def Fun(self,command):
        ...
        if 'your name' in command:
            ...
            self.talk("your name is no one")  ###################################################
        elif 'university name' in command:
            self.talk("you are studing in Anna university, with batcheloe in Computer Science ") 
    ...
    def open_source(self,command):
        ...
        if 'github' in command:
            ...
            webbrowser.open('https://github.com/tuesdaydev')
    ...
    #News
    def news(self):
        MAIN_URL_= "https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=054f852e06654cdeb7c6f0255b9b8427"
...
class Main(QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie("D:/project/Investigation and Development of the Artificial Intelligent Voice Assistant Using Machine Learning/JARVIS/JARVIS/UI/ironman1.gif")
        self.ui.label_2.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("D:/project/Investigation and Development of the Artificial Intelligent Voice Assistant Using Machine Learning/JARVIS/JARVIS/UI/ringJar.gif")
        self.ui.label_3.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("D:/project/Investigation and Development of the Artificial Intelligent Voice Assistant Using Machine Learning/JARVIS/JARVIS/UI/circle.gif")
        self.ui.label_4.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("D:/project/Investigation and Development of the Artificial Intelligent Voice Assistant Using Machine Learning/JARVIS/JARVIS/UI/lines1.gif")
        self.ui.label_7.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(" D:/project/Investigation and Development of the Artificial Intelligent Voice Assistant Using Machine Learning/JARVIS/JARVIS/UI/ironman3.gif")
        self.ui.label_8.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(" D:/project/Investigation and Development of the Artificial Intelligent Voice Assistant Using Machine Learning/JARVIS/JARVIS/UI/circle.gif")
        self.ui.label_9.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(" D:/project/Investigation and Development of the Artificial Intelligent Voice Assistant Using Machine Learning/JARVIS/JARVIS/UI/powersource.gif")
        self.ui.label_12.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(" D:/project/Investigation and Development of the Artificial Intelligent Voice Assistant Using Machine Learning/JARVIS/JARVIS/UI/powersource.gif")
        self.ui.label_13.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(" D:/project/Investigation and Development of the Artificial Intelligent Voice Assistant Using Machine Learning/JARVIS/JARVIS/UI/ironman3_flipped.gif")
