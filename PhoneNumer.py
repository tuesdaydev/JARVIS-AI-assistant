def Phonenumber_location_tracker():
    ...
    mymap.save(f"D:\\project\\Investigation and Development of the Artificial Intelligent Voice Assistant Using Machine Learning\\JARVIS\\JARVIS\\JARVIS\\Maps\\{num+str('-')+str(time_)}.html")
